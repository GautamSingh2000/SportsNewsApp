...
import com.mindgeeks.sportsnews.models.ResponseModel.Batsmen
import com.mindgeeks.sportsnews.R


class adapterBattingScoreCard(val data : List<Batsmen>): RecyclerView.Adapter<adapterBattingScoreCard.ScoreCardViewHolder>() {
