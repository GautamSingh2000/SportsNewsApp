...
import com.mindgeeks.sportsnews.models.ResponseModel.Bowler
import com.mindgeeks.sportsnews.R

class adapterBallingScoreCard(val data : List<Bowler>): RecyclerView.Adapter<adapterBallingScoreCard.ScoreCardViewHolder>() {
    lateinit var Scorelist : List<Bowler>
    ...
    override fun onBindViewHolder(holder: ScoreCardViewHolder, position: Int) {
        ...
        holder.e2.text = data.overs
        holder.e3.text = "0"
        holder.e4.text = data.runs_conceded
        holder.e5.text = data.wickets
        holder.e6.text = data.econ
    }
