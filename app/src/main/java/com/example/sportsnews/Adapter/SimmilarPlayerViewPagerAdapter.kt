...
import com.mindgeeks.sportsnews.Screens.Activity.PlayerDetailActivity
import com.squareup.picasso.Picasso

class SimmilarPlayerViewPagerAdapter(val context: Context, val list : ArrayList<PlayerData>) : RecyclerView.Adapter<SimmilarPlayerViewPagerAdapter.ViewHolder>() {
