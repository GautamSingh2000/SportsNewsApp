...
import com.mindgeeks.sportsnews.adapters.viewPagerAdapter_PlayerStats
import com.mindgeeks.sportsnews.adapters.viewPagerAdapter_SimmilarPlayer
...
class Activity_Player_Detail : AppCompatActivity() {
    ...
    lateinit var adapter: viewPagerAdapter_PlayerStats
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = viewPagerAdapter_PlayerStats(this)
        ...
        if (playerid != null) {
            ...
            viewModel.GetPlayerDetail(request = request).observe(this@Activity_Player_Detail) {
                when {
                    it.status == 200 -> {
            ...
            if (it.status == 200) {
                try {
                    ...
                    binding.simmilarplayers.adapter =
                        viewPagerAdapter_SimmilarPlayer(this, SimmilarPlayerList)
