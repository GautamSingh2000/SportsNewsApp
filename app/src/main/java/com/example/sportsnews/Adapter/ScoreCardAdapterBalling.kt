...
import com.mindgeeks.sportsnews.Model.ResponseModel.Bowler
import com.mindgeeks.sportsnews.R

class ScoreCardAdapterBalling(val data : List<Bowler>): RecyclerView.Adapter<ScoreCardAdapterBalling.ScoreCardViewHolder>() {
