...
class SplashScreen : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        slide_up  = AnimationUtils.loadAnimation(this,R.anim.mike_slideup)
        slide_in = AnimationUtils.loadAnimation(this,R.anim.mike_slidedown)
        ...
        left_out = AnimationUtils.loadAnimation(this,R.anim.left_slide_out)
        ...
        coroutineScope.launch {
            try {
                ...
                Toast.makeText(this@SplashScreen, "Restart Your App !!", Toast.LENGTH_LONG).show()
            }
        }
    ...
    private fun switchMainScreen(screen : String) {
        var intent = Intent()
        if(screen.equals("mainScreen")) intent = Intent(context, MainActivity::class.java)
